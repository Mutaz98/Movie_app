...
part of 'detail_api_interface.dart';
...
class _DetailAPIInterface implements DetailAPIInterface {
  _DetailAPIInterface(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<TvShow> getDetailsTv({
    ...
    final _options = _setStreamType<TvShow>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late TvShow _value;
    try {
      _value = TvShow.fromJson(_result.data!);
    } on Object catch (e, s) {
